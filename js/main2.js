...
function verFinal2(){
		...
		var canvas = document.getElementById('canvas500');
    var context = canvas.getContext('2d');
    alert($('#canvas2').html());
		rasterizeHTML.drawHTML($('#canvas2').html(),canvas).then(function (result) {
							//	context.drawImage(result.image, 500, 500);
						/*	 var base64image = result.toDataURL("image/jpeg");
							 		alert(result);
							save_img(base64image);*/
					 }, function (e) {
